...
function mixinMigration(MsSQL) {
  ...
  MsSQL.prototype.addAndAlterColumns = function(statements, model, propNames, actualFields, idName) {
    var self = this;
  ...
  MsSQL.prototype.removeColumns = function(statements, model, propNames, actualFields, idName) {
    var self = this;
    var m = this._models[model];
    var columnsToDrop = [];
  ...
  MsSQL.prototype.removeIndexes = function(sql, ai, idName) {
  ...
  MsSQL.prototype.addSingleColumnIndexes = function(sql, m, propNames, ai) {
    propNames.forEach(function(propName) {
  ...
  MsSQL.prototype.addMultiColumnIndexes = function(sql, m, indexNames, ai) {
  ...
  MsSQL.prototype.alterTable = function(model, actualFields, actualIndexes, done, checkOnly) {
    ...
    self.addAndAlterColumns(statements, model, propNames, actualFields, idName);

    // drop columns
    self.removeColumns(statements, model, propNames, actualFields, idName);

    // remove indexes
    self.removeIndexes(sql, ai, idName);

    // add single-column indexes
    self.addSingleColumnIndexes(sql, m, propNames, ai);

    // add multi-column indexes
    self.addMultiColumnIndexes(sql, m, indexNames, ai);
